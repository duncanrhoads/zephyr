...
#if defined(CONFIG_BINDESC_MANIFEST_VERSION)
BINDESC_STR_DEFINE(app_manifest_version, BINDESC_ID_APP_MANIFEST_VERSION,
		   STRINGIFY(APP_MANIFEST_VERSION));
#endif /* CONFIG_BINDESC_MANIFEST_VERSION */
